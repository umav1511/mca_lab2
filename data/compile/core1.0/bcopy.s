...
;;								## 0
	c0    cmplt $b0.0 = $r0.4, 4   ## [spec] bblock 20, line 4-3,  t175(I1),  t80,  4(SI32)
	c0    cmplt $b0.3 = $r0.4, 3   ## [spec] bblock 17, line 4-4,  t174(I1),  t80,  3(SI32)
	c0    cmplt $b0.4 = $r0.4, 2   ## [spec] bblock 14, line 4-5,  t173(I1),  t80,  2(SI32)
	c0    brf $b0.0, L1?3   ## bblock 1, line 4,  t169(I1)
;;								## 1
	c0    stb 0[$r0.5] = $r0.3   ## bblock 3, line 5, t78, t30(SI8)
	c0    cmplt $b0.5 = $r0.4, 1   ## [spec] bblock 11, line 4-6,  t172(I1),  t80,  1(SI32)
	c0    cmplt $b0.6 = $r0.4, $r0.0   ## [spec] bblock 8, line 4-7,  t171(I1),  t80,  0(SI32)
	c0    add $r0.4 = $r0.4, 8   ## [spec] bblock 5, line 0,  t80,  t80,  8(I32)
;;								## 2
	c0    ldb.d $r0.3 = 1[$r0.2]   ## [spec] bblock 23, line 5-1, t54(SI8), t79
	c0    brf $b0.1, L2?3   ## bblock 3, line 4-1,  t170(I1)
;;								## 3
;;								## 4
