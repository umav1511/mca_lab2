...
;;								## 3
	c0    slct $r0.13 = $b0.1, $r0.6, $r0.14   ## [spec] bblock 23, line 66-1,  t53,  t52(I1),  t61,  t30
...
;;								## 5
	c0    ldb.d $r0.13 = 0[$r0.9]   ## [spec] bblock 17, line 64-4, t39(SI8), t57
...
;;								## 7
	c0    slct $r0.15 = $b0.1, $r0.8, $r0.3   ## [spec] bblock 17, line 66-3,  t45,  t44(I1),  t56,  t49
	c0    cmpne $b0.0 = $r0.13, $r0.0   ## [spec] bblock 17, line 64-4,  t88(I1),  t39(SI8),  0(SI32)
	c0    cmpeq $b0.1 = $r0.13, $r0.4   ## [spec] bblock 14, line 65-4,  t40(I1),  t39(SI8),  t1(SI8)
	c0    brf $b0.0, L4?3   ## bblock 20, line 64-3,  t89(I1)
;;								## 8
	c0    slct $r0.3 = $b0.1, $r0.9, $r0.15   ## [spec] bblock 14, line 66-4,  t41,  t40(I1),  t57,  t45
	c0    cmpne $b0.0 = $r0.14, $r0.0   ## [spec] bblock 14, line 64-5,  t87(I1),  t35(SI8),  0(SI32)
...
;;								## 9
	...
	c0    ldb.d $r0.14 = 0[$r0.11]   ## [spec] bblock 11, line 64-6, t34(SI8), t59
	c0    add $r0.8 = $r0.8, 8   ## [spec] bblock 5, line 0,  t56,  t56,  8(I32)
	c0    brf $b0.0, L6?3   ## bblock 14, line 64-5,  t87(I1)
;;								## 10
	c0    ldb.d $r0.3 = 0[$r0.12]   ## [spec] bblock 8, line 64-7, t28(SI8), t60
	c0    add $r0.10 = $r0.10, 8   ## [spec] bblock 5, line 0,  t58,  t58,  8(I32)
	c0    add $r0.9 = $r0.9, 8   ## [spec] bblock 5, line 0,  t57,  t57,  8(I32)
;;								## 11
	c0    cmpne $b0.0 = $r0.14, $r0.0   ## bblock 11, line 64-6,  t86(I1),  t34(SI8),  0(SI32)
	c0    cmpeq $b0.1 = $r0.14, $r0.4   ## [spec] bblock 8, line 65-6,  t32(I1),  t34(SI8),  t1(SI8)
;;								## 12
	c0    slct $r0.14 = $b0.1, $r0.11, $r0.13   ## [spec] bblock 8, line 66-6,  t33,  t32(I1),  t59,  t37
	c0    cmpne $b0.0 = $r0.3, $r0.0   ## [spec] bblock 8, line 64-7,  t85(I1),  t28(SI8),  0(SI32)
	c0    cmpeq $b0.1 = $r0.3, $r0.4   ## [spec] bblock 5, line 65-7,  t24(I1),  t28(SI8),  t1(SI8)
	c0    brf $b0.0, L7?3   ## bblock 11, line 64-6,  t86(I1)
;;								## 13
	c0    slct $r0.5 = $b0.1, $r0.12, $r0.14   ## [spec] bblock 5, line 66-7,  t23,  t24(I1),  t60,  t33
...
L8?3:
.return ret($r0.3:u32)
	c0    mov $r0.3 = $r0.14   ## bblock 6, line 0,  t29,  t33
...
;;								## 9
	c0    ldw $r0.4 = 0x20[$r0.1]  ## restore ## t125
;;								## 10
...
;;								## 6
	...
	c0    brf $b0.0, L11?3   ## bblock 41, line 93,  t149(I1)
;;								## 7
	c0    ldw.d $l0.0 = 0[$r0.3]   ## [spec] bblock 43, line 130, t52, t151
	c0    br $b0.0, L13?3   ## bblock 42, line 130,  t150(I1)
;;								## 8
;;								## 9
...
;;								## 6
	c0    br $b0.0, L14?3   ## bblock 55, line 113,  t152(I1)
;;								## 7
L11?3:
...
;;								## 1
	...
	c0    br $b0.0, L15?3   ## bblock 56, line 113,  t153(I1)
;;								## 2
	c0    br $b0.0, L15?3   ## bblock 57, line 113,  t154(I1)
	      ## goto
;;
	c0    goto L11?3 ## goto
;;								## 3
...
L22?3:
	...
	c0    mov $r0.5 = (CompBuf + 0)   ## addr(CompBuf?1.0)(P32)
;;								## 15
	c0    ldw $r0.6 = ((nomagic + 0) + 0)[$r0.0]   ## bblock 13, line 156, t68, 0(I32)
	c0    mov $r0.4 = (UnComp + 0)   ## addr(UnComp?1.0)(P32)
;;								## 16
	c0    add $r0.8 = $r0.2, -1   ## [spec] bblock 16, line 159,  t71,  t64,  -1(SI32)
	c0    mov $r0.9 = ((CompBuf + 0) + 1)   ## (addr(CompBuf?1.0)(P32) + 0x1(I32))(P32)
;;								## 17
	c0    cmpeq $b0.0 = $r0.6, $r0.0   ## bblock 13, line 156,  t141(I1),  t68,  0(SI32)
	c0    cmpge $b0.1 = $r0.8, $r0.0   ## [spec] bblock 16, line 158,  t142(I1),  t71,  0(SI32)
	c0    ldb.d $r0.10 = ((CompBuf + 0) + 0)[$r0.0]   ## [spec] bblock 31, line 158, t74(SI8), 0(I32)
;;								## 18
	c0    ldbu.d $r0.6 = ((magic_header + 0) + 0)[$r0.0]   ## [spec] bblock 18, line 158, t77(I8), 0(I32)
...
;;								## 20
	...
	c0    and $r0.6 = $r0.6, 255   ## [spec] bblock 18, line 158,  t78,  t77(I8),  255(I32)
;;								## 21
	c0    stw ((outbuf + 0) + 0)[$r0.0] = $r0.4   ## bblock 13, line 154, 0(I32), addr(UnComp?1.0)(P32)
	c0    cmpne $b0.2 = $r0.10, $r0.6   ## [spec] bblock 18, line 158,  t143(I1),  t69(I8),  t78
	c0    brf $b0.0, L23?3   ## bblock 13, line 156,  t141(I1)
;;								## 22
	c0    stw ((buflen + 0) + 0)[$r0.0] = $r0.8   ## bblock 16, line 158, 0(I32), t71
...
;;								## 0
	c0    ldw.d $r0.5 = ((bufp + 0) + 0)[$r0.0]   ## [spec] bblock 27, line 164, t95, 0(I32)
...
;;								## 2
	...
	c0    add $r0.8 = $r0.5, 1   ## [spec] bblock 27, line 164,  t96,  t95,  1(SI32)
;;								## 3
	c0    brf $b0.0, L30?3   ## bblock 22, line 164,  t146(I1)
;;								## 4
	c0    stw ((bufp + 0) + 0)[$r0.0] = $r0.8   ## bblock 27, line 164, 0(I32), t96
;;								## 5
	c0    ldb $r0.5 = 0[$r0.5]   ## bblock 27, line 164, t97(SI8), t95
;;								## 6
;;								## 7
	c0    zxtb $r0.5 = $r0.5   ## bblock 27, line 164,  t92(I8),  t97(SI8)
	c0    stw ((fsize + 0) + 0)[$r0.0] = $r0.6   ## bblock 24, line 168, 0(I32), 100000(SI32)
;;								## 8
L31?3:
	c0    and $r0.6 = $r0.5, 128   ## bblock 24, line 165,  t100,  t92(I8),  128(I32)
	c0    and $r0.2 = $r0.5, 31   ## bblock 24, line 166,  t105,  t92(I8),  31(I32)
;;								## 9
	c0    stw ((block_compress + 0) + 0)[$r0.0] = $r0.6   ## bblock 24, line 165, 0(I32), t100
...
;;								## 0
	c0    mov $r0.3 = $r0.0   ## 0(SI32)
	c0    ldw $r0.7 = 0x24[$r0.1]  ## restore ## t127
;;								## 1
	c0    ldw $l0.0 = 0x10[$r0.1]  ## restore ## t111
;;								## 2
...
.trace 34
L30?3:
	c0    mov $r0.5 = -1   ## bblock 23, line 164,  t92(I8),  -1(SI32)
	c0    mov $r0.4 = 1   ## 1(SI32)
	c0    mov $r0.6 = 100000   ## 100000(SI32)
;;								## 0
	c0    stw ((fsize + 0) + 0)[$r0.0] = $r0.6   ## bblock 24, line 168, 0(I32), 100000(SI32)
...
L24?3:
	...
	c0    mov $r0.3 = (_?1STRINGPACKET.5 + 0)   ## addr(_?1STRINGVAR.5)(P32)
;;								## 0
	c0    cmpne $b0.0 = $r0.10, $r0.6   ## bblock 18, line 158,  t143(I1),  t69(I8),  t78
;;								## 1
...
;;								## 5
	c0    cmpne $b0.0 = $r0.10, $r0.0   ## bblock 1, line 205,  t209(I1),  t26,  0(SI32)
...
;;								## 8
	c0    cmpeq $b0.1 = $r0.6, $r0.5   ## bblock 80, line 233-1,  t256(I1),  t175,  t114
	c0    cmpgt $b0.2 = $r0.6, $r0.0   ## [spec] bblock 81, line 238-1,  t257(I1),  t175,  0(SI32)
...
;;								## 22
	c0    cmpeq $b0.1 = $r0.6, $r0.5   ## bblock 64, line 233-5,  t244(I1),  t155,  t114
	c0    cmpgt $b0.2 = $r0.6, $r0.0   ## [spec] bblock 65, line 238-5,  t245(I1),  t155,  0(SI32)
...
;;								## 11
	c0    add $r0.10 = $r0.2, 1   ## bblock 34, line 195,  t23,  t22,  1(SI32)
	c0    ldw $r0.11 = ((maxbits + 0) + 0)[$r0.0]   ## bblock 34, line 195, t19, 0(I32)
;;								## 12
	c0    stw ((outbuf + 0) + 0)[$r0.0] = $r0.10   ## bblock 34, line 195, 0(I32), t23
;;								## 13
	c0    or $r0.3 = $r0.3, $r0.11   ## bblock 34, line 195,  t20,  t18,  t19
;;								## 14
...
;;								## 9
	...
	c0    add $r0.12 = $r0.8, 2   ## bblock 25, line 287,  t3,  t21,  2(SI32)
	c0    shr $r0.11 = $r0.3, 8   ## bblock 25, line 288,  t111(SI24),  t334,  8(SI32)
...
;;								## 3
;;								## 4
	c0    add $r0.4 = $r0.2, 1   ## bblock 4, line 357,  t19,  t18,  1(SI32)
;;								## 5
	c0    stw ((outbuf + 0) + 0)[$r0.0] = $r0.4   ## bblock 4, line 357, 0(I32), t19
;;								## 6
...
;;								## 3
	...
	c0    brf $b0.3, L137?3   ## bblock 11, line 423,  t168(I1)
;;								## 4
...
;;								## 12
	...
	c0    brf $b0.3, L141?3   ## bblock 37, line 423-1,  t177(I1)
;;								## 13
...
;;								## 19
	c0    cmpeq $b0.3 = $r0.8, 255   ## bblock 39, line 424-1,  t178(I1),  t130(I8),  255(SI32)
;;								## 20
	c0    br $b0.3, L143?3   ## bblock 39, line 424-1,  t178(I1)
;;								## 21
	c0    brf $b0.0, L144?3   ## bblock 40, line 421-2,  t179(I1)
;;								## 22
	c0    stw ((buflen + 0) + 0)[$r0.0] = $r0.2   ## bblock 29, line 423-2, 0(I32), t112
	c0    brf $b0.1, L145?3   ## bblock 29, line 423-2,  t174(I1)
;;								## 23
...
;;								## 31
	c0    brf $b0.2, L148?3   ## bblock 32, line 421-3,  t176(I1)
;;								## 32
...
L166?3:
	...
	c0    mov $r0.6 = -1   ## -1(SI32)
;;								## 0
	c0    cmpgt $b0.0 = $r0.2, 3   ## [spec] bblock 27, line 547-3,  t151(I1),  t43,  3(SI32)
...
;;								## 4
	...
	c0    brf $b0.0, L167?3   ## bblock 27, line 547-3,  t151(I1)
;;								## 5
