...
;;								## 1
	c0    add $r0.9 = $r0.6, 1   ## bblock 18, line 57,  t3,  t2,  1(SI32)
...
L3?3:
	...
	c0    cmpge $r0.9 = $r0.5, 7   ## [spec] bblock 28, line 65-3,  t118(I1),  t117,  7(SI32)
	c0    cmpge $r0.10 = $r0.5, 6   ## [spec] bblock 25, line 65-4,  t130(I1),  t117,  6(SI32)
	c0    cmpge $r0.11 = $r0.5, 5   ## [spec] bblock 19, line 65-5,  t135(I1),  t117,  5(SI32)
	c0    cmpge $r0.12 = $r0.5, 4   ## [spec] bblock 16, line 65-6,  t140(I1),  t117,  4(SI32)
;;								## 0
	c0    ldw.d $r0.13 = 4[$r0.2]   ## [spec] bblock 17, line 66-1, t13, t163
	c0    cmpge $r0.14 = $r0.5, 3   ## [spec] bblock 12, line 65-7,  t143(I1),  t117,  3(SI32)
;;								## 1
	c0    cmpgeu $r0.3 = $r0.4, $r0.3   ## bblock 2, line 67,  t91(I1),  t80,  t124
	c0    ldw.d $r0.15 = 8[$r0.2]   ## [spec] bblock 31, line 66-2, t131, t163
;;								## 2
	c0    norl $b0.0 = $r0.6, $r0.3   ## bblock 2, line 65,  t195(I1),  t123(I1),  t91(I1)
	c0    cmpgeu $r0.13 = $r0.4, $r0.13   ## [spec] bblock 17, line 67-1,  t145(I1),  t80,  t13
	c0    ldw.d $r0.3 = 12[$r0.2]   ## [spec] bblock 28, line 66-3, t127, t163
;;								## 3
	c0    norl $b0.0 = $r0.7, $r0.13   ## [spec] bblock 17, line 65-1,  t200(I1),  t90(I1),  t145(I1)
	c0    cmpgeu $r0.15 = $r0.4, $r0.15   ## [spec] bblock 31, line 67-2,  t120(I1),  t80,  t131
	c0    ldw.d $r0.6 = 16[$r0.2]   ## [spec] bblock 25, line 66-4, t136, t163
	c0    brf $b0.0, L4?3   ## bblock 2, line 65,  t195(I1)
;;								## 4
	c0    norl $b0.0 = $r0.8, $r0.15   ## [spec] bblock 31, line 65-2,  t204(I1),  t122(I1),  t120(I1)
...
;;								## 5
	c0    norl $b0.0 = $r0.9, $r0.3   ## [spec] bblock 28, line 65-3,  t203(I1),  t118(I1),  t126(I1)
...
;;								## 6
	c0    norl $b0.0 = $r0.10, $r0.6   ## [spec] bblock 25, line 65-4,  t202(I1),  t130(I1),  t129(I1)
...
;;								## 1
	c0    add $r0.6 = $r0.2, 1   ## [spec] bblock 15, line 72,  t16,  t15,  1(SI32)
	c0    brf $b0.0, L13?3   ## bblock 3, line 71,  t196(I1)
;;								## 2
	c0    stw ((record_ptr + 0) + 0)[$r0.0] = $r0.6   ## bblock 15, line 72, 0(I32), t16
;;								## 3
	c0    stb 0[$r0.2] = $r0.7   ## bblock 15, line 72, t15, 48(SI32)
;;								## 4
	c0    stb 0xd1000000[$r0.0] = $r0.8   ## bblock 15, line 73, 0(I32), 48(I32)
;;								## 5
L16?3:
...
;;								## 1
	c0    add $r0.3 = $r0.4, 1   ## bblock 0, line 95,  t2,  t1,  1(SI32)
;;								## 2
	c0    stw ((record_ptr + 0) + 0)[$r0.0] = $r0.3   ## bblock 0, line 95, 0(I32), t2
;;								## 3
...
;;								## 0
	...
	c0    shru $r0.6 = $r0.2, 28   ## [spec] bblock 3, line 100-1,  t64(I4),  t45,  28(SI32)
	c0    shl $r0.2 = $r0.2, 4   ## [spec] bblock 3, line 104-1,  t73,  t45,  4(SI32)
	c0    brf $b0.0, L18?3   ## bblock 1, line 99,  t91(I1)
;;								## 1
	c0    add $r0.7 = $r0.3, 48   ## bblock 3, line 101,  t13,  t14(SI8),  48(SI32)
	c0    add $r0.3 = $r0.3, 55   ## bblock 3, line 101,  t44,  t14(SI8),  55(SI32)
	c0    cmplt $b0.0 = $r0.3, 10   ## bblock 3, line 101,  t92(I1),  t14(SI8),  10(SI32)
	c0    add $r0.8 = $r0.4, 1   ## bblock 3, line 102,  t46,  t47,  1(SI32)
	c0    sxtb $r0.6 = $r0.6   ## bblock 3, line 100-1,  t65(SI8),  t64(I4)
	c0    shru $r0.9 = $r0.2, 28   ## bblock 3, line 100-2,  t53(I4),  t73,  28(SI32)
	c0    shl $r0.2 = $r0.2, 4   ## bblock 3, line 104-2,  t62,  t73,  4(SI32)
;;								## 2
	c0    slct $r0.7 = $b0.0, $r0.7, $r0.3   ## bblock 3, line 101,  t50,  t92(I1),  t13,  t44
	c0    add $r0.3 = $r0.6, 48   ## bblock 3, line 101-1,  t66,  t65(SI8),  48(SI32)
	c0    add $r0.6 = $r0.6, 55   ## bblock 3, line 101-1,  t67,  t65(SI8),  55(SI32)
	c0    cmplt $b0.0 = $r0.6, 10   ## bblock 3, line 101-1,  t93(I1),  t65(SI8),  10(SI32)
	c0    sxtb $r0.9 = $r0.9   ## bblock 3, line 100-2,  t54(SI8),  t53(I4)
	c0    shru $r0.10 = $r0.2, 28   ## bblock 3, line 100-3,  t9(I4),  t62,  28(SI32)
	c0    shl $r0.2 = $r0.2, 4   ## bblock 3, line 104-3,  t41,  t62,  4(SI32)
;;								## 3
	c0    sxtb $r0.11 = $r0.7   ## bblock 3, line 101,  t49(SI8),  t50
	c0    zxtb $r0.7 = $r0.7   ## bblock 3, line 103,  t48(I8),  t50
	c0    slct $r0.3 = $b0.0, $r0.3, $r0.6   ## bblock 3, line 101-1,  t68,  t93(I1),  t66,  t67
	c0    add $r0.6 = $r0.9, 48   ## bblock 3, line 101-2,  t55,  t54(SI8),  48(SI32)
	...
	c0    sxtb $r0.10 = $r0.10   ## bblock 3, line 100-3,  t43(SI8),  t9(I4)
;;								## 4
	c0    stw ((record_ptr + 0) + 0)[$r0.0] = $r0.8   ## bblock 3, line 102, 0(I32), t46
	c0    sxtb $r0.12 = $r0.3   ## bblock 3, line 101-1,  t69(SI8),  t68
	c0    zxtb $r0.3 = $r0.3   ## bblock 3, line 103-1,  t70(I8),  t68
	c0    slct $r0.6 = $b0.0, $r0.6, $r0.9   ## bblock 3, line 101-2,  t57,  t94(I1),  t55,  t56
	c0    add $r0.9 = $r0.10, 48   ## bblock 3, line 101-3,  t42,  t43(SI8),  48(SI32)
	c0    add $r0.10 = $r0.10, 55   ## bblock 3, line 101-3,  t15,  t43(SI8),  55(SI32)
	c0    cmplt $b0.0 = $r0.10, 10   ## bblock 3, line 101-3,  t95(I1),  t43(SI8),  10(SI32)
;;								## 5
	c0    stb 0[$r0.4] = $r0.11   ## bblock 3, line 102, t47, t49(SI8)
	c0    sxtb $r0.8 = $r0.6   ## bblock 3, line 101-2,  t58(SI8),  t57
	c0    zxtb $r0.6 = $r0.6   ## bblock 3, line 103-2,  t59(I8),  t57
	c0    slct $r0.9 = $b0.0, $r0.9, $r0.10   ## bblock 3, line 101-3,  t16,  t95(I1),  t42,  t15
;;								## 6
	c0    stb 0xd1000000[$r0.0] = $r0.7   ## bblock 3, line 103, 0(I32), t48(I8)
	c0    sxtb $r0.4 = $r0.9   ## bblock 3, line 101-3,  t21(SI8),  t16
	c0    zxtb $r0.9 = $r0.9   ## bblock 3, line 103-3,  t22(I8),  t16
;;								## 7
	c0    ldw $r0.7 = ((record_ptr + 0) + 0)[$r0.0]   ## bblock 3, line 102-1, t71, 0(I32)
;;								## 8
;;								## 9
	c0    add $r0.10 = $r0.7, 1   ## bblock 3, line 102-1,  t72,  t71,  1(SI32)
;;								## 10
	c0    stw ((record_ptr + 0) + 0)[$r0.0] = $r0.10   ## bblock 3, line 102-1, 0(I32), t72
;;								## 11
	c0    stb 0[$r0.7] = $r0.12   ## bblock 3, line 102-1, t71, t69(SI8)
;;								## 12
	c0    stb 0xd1000000[$r0.0] = $r0.3   ## bblock 3, line 103-1, 0(I32), t70(I8)
;;								## 13
	c0    ldw $r0.3 = ((record_ptr + 0) + 0)[$r0.0]   ## bblock 3, line 102-2, t60, 0(I32)
;;								## 14
;;								## 15
	c0    add $r0.7 = $r0.3, 1   ## bblock 3, line 102-2,  t61,  t60,  1(SI32)
;;								## 16
	c0    stw ((record_ptr + 0) + 0)[$r0.0] = $r0.7   ## bblock 3, line 102-2, 0(I32), t61
;;								## 17
	c0    stb 0[$r0.3] = $r0.8   ## bblock 3, line 102-2, t60, t58(SI8)
;;								## 18
	c0    stb 0xd1000000[$r0.0] = $r0.6   ## bblock 3, line 103-2, 0(I32), t59(I8)
;;								## 19
	c0    ldw $r0.3 = ((record_ptr + 0) + 0)[$r0.0]   ## bblock 3, line 102-3, t19, 0(I32)
;;								## 20
;;								## 21
	c0    add $r0.6 = $r0.3, 1   ## bblock 3, line 102-3,  t20,  t19,  1(SI32)
;;								## 22
	c0    stw ((record_ptr + 0) + 0)[$r0.0] = $r0.6   ## bblock 3, line 102-3, 0(I32), t20
;;								## 23
	c0    stb 0[$r0.3] = $r0.4   ## bblock 3, line 102-3, t19, t21(SI8)
;;								## 24
	c0    stb 0xd1000000[$r0.0] = $r0.9   ## bblock 3, line 103-3, 0(I32), t22(I8)
	c0    goto L17?3 ## goto
;;								## 25
.trace 4
L18?3:
...
;;								## 0
	c0    ldw $r0.6 = ((record_ptr + 0) + 0)[$r0.0]   ## bblock 2, line 125, t10, 0(I32)
;;								## 1
;;								## 2
	c0    add $r0.7 = $r0.6, 1   ## bblock 2, line 125,  t11,  t10,  1(SI32)
;;								## 3
	c0    stw ((record_ptr + 0) + 0)[$r0.0] = $r0.7   ## bblock 2, line 125, 0(I32), t11
;;								## 4
	c0    stb 0[$r0.6] = $r0.2   ## bblock 2, line 125, t10, 58(SI32)
;;								## 5
