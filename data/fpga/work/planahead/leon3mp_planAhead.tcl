...
read_verilog -library work /opt/Xilinx/14.7/ISE_DS/ISE/verilog/src/glbl.v
...
read_vhdl -library work ptag.vhd
read_vhdl -library work gracectrl.vhd
...
set_property steps.xst.args.opt_level 1 [get_runs synth_1]
set_property steps.xst.args.resource_sharing yes [get_runs synth_1]
set_property steps.xst.args.equivalent_register_removal yes [get_runs synth_1]
set_property steps.xst.args.register_balancing no [get_runs synth_1]
